                    ...
                    <div id="level-<?php echo $i ?>" class="level <?php echo ($i == 1) ? "level-active" : "" ?>">
                        <div class="btnContainer">
                            <div class="elevator-buttons-<?php echo $i ?>"" style="display:<?php echo ($i !== 1) ? "none" : "" ?>">
                                <?php for ($btnI = 5; $btnI > 0; $btnI--) { ?>
                                    <button class="btn btn-info btnLevel elevatorButtons-<?php echo $btnI ?>" data-level="<?php echo $btnI ?>"> <?php echo $btnI ?></button>
                                <?php } ?>
                            </div>
                        </div>
                        <span class="level-indicator">
                            <div class="row">
                                <div class="col-md-12">
                                    <?php if($i != 5) { ?>
                                        <button class="btn-call-up btn btn-primary glyphicon glyphicon-upload" data-level="<?php echo $i ?>"></button><br>
                                    <?php } ?>

                                    <span class="label label-default level-indicator-label"><?php echo $i ?></span>

                                    <?php if ($i != 1) { ?>
                                        <br><button class="btn-call-down btn btn-primary glyphicon glyphicon-download" data-level="<?php echo $i ?>"></button>
                                    <?php } ?>
                                </div>
                            </div>
                        </span>
